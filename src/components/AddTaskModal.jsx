...
export default function AddTaskModal({ listId, accentColor, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true)
    const { error } = await addTask(listId, {
      title: title.trim(),
      ...
      >
        <div className="bg-bg-card border border-border rounded-t-2xl md:rounded-2xl overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between px-5 py-3 border-b border-border">
            <h2 className="text-tx-primary text-sm font-semibold">New task</h2>
